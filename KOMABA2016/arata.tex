...
%\subsection{\texorpdfstring{\ruby{余接関数}{コタンジェント}}{余接関数}のローラン展開と\texorpdfstring{\ruby{正接関数}{タンジェント}}{正接関数}のテイラー展開}
\subsection{余接関数のローラン展開と正接関数のテイラー展開}

ベルヌーイ数の\ruby{母関数}{ぼかんすう}を使うと、余接関数 $\cot z=\frac{\cos z}{\sin z}$ のローラン展開を書き下せる。
